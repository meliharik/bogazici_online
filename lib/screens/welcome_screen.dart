              ...
              Center(
                child: Column(
                  children: <Widget>[
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: CircleAvatar(
                            ...
                            child: Icon(Icons.check,color: Colors.white,size: 65,),
                            radius: 50,
                          ),
                        ),
                      ],
                    ...
                    Text('HOŞGELDIN!',style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 35,
                      fontWeight: FontWeight.bold),),
                    SizedBox(height: MediaQuery.of(context).size.height * (0.2/10),),
                    Text('Üniversitenin Tadını Bizimle\nÇıkarmaya Var mısın?',
                      textAlign: TextAlign.center,style: TextStyle(color: Colors.black.withOpacity(0.4),
                        fontSize: 20),),
                    SizedBox(height: MediaQuery.of(context).size.height * (0.5/10),),
                    Container(
